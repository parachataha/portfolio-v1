    ...
    return ( 
        <div className="Home">
            ...
            <section id="about">
                ...
                <p className="reveal center about-text"> I've created a blog to <b>help others</b> learn how to code, design and problem solve. As a <b>self-taught</b> coder and designer, it was incredibly hard to keep swapping between  tutorials with different methods techniques, so I took the time to see <b>what made me struggle</b> and to create a blog that allows others to learn without the extra struggles I went through. The blog solves common <b>beginner and advanced</b> problems, making sure I explain each step of the way.</p>
